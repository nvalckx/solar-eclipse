...
Location is saved only in browser storage. Browser geolocation is requested only after the visitor presses **Use my current location**. Terrain, weather, atmospheric transparency, and detailed lunar-limb effects are not modeled.
